...
export default function Galleries() {
  ...
  const imagesArray = [
    ...
    {
      src: "..\\images\\Brighton Beach\\1.jpg", title: "Brighton Beach", alt: "Brighton Beach"
    },
    {
      src: "..\\images\\Pride\\1.jpg", title: "Pride", alt: "Pride"
      
    },
    {
      src: "..\\images\\Birds\\1.jpg", title: "Birds", alt: "Birds"
    },
  ];
  ...
  return (
    <div>
      ...
      <div className="flex flex-col items-center justify-center px-10 lg:px-20 pb-20 mt-32">
        <span className="text-5xl font-bold text-center font-old-standard text-black mb-8">Galleries</span>
